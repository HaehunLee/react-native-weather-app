...
const API_KEY = '639b691b227d38d44c69f1384b5991fb';
...
const WeatherView = ({}: Props) => {
    ...
    let data = [];
    const { isLoading, weather, temperacture } = weatherInfo;
    if(weather && temperacture) {
        ...
        <Container>
            ...
            renderItem={({ item, index }) => (
                <WeatherItemContainer>
                    ...
                    <Temperature>{(item as IWeather).temperacture}도</Temperature>
                </WeatherItemContainer>
            )}
